...
public class MySQLite extends SQLiteOpenHelper {
    ...
    public MySQLite(Context context){
        ...
        super(context,"animalsDB",null,DATABASEVERSION);
    ...
    public int aktualizuj(Animal zwierz) {
        ...
        int i = db.update("animals" , values, "_ id =?" , new String[]{String.valueOf(zwierz.getId())});
        db.close();
        return i;
    }
    ...
    public Animal pobierz(int id){
        ...
        Cursor cursor = db.query("animals" ,//a. table name
                        new String[] {" _ id" , "gatunek" , "kolor" , "wielkosc" , "opis"},// b. columnnames
                        " id = ?" ,// c. selections
